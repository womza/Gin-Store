						...
						<a href="{$accessoryLink|escape:'htmlall':'UTF-8'}" data-ajax="false">
							<div class="clearfix" >
								<div class="col-left" style="width:{$mediumSize.width+10}px;">
									<img src="{$link->getImageLink($accessory.link_rewrite, $accessory.id_image, 'medium_dm')|escape:'html'}" alt="{$accessory.legend|escape:'htmlall':'UTF-8'}" width="{$mediumSize.width}" height="{$mediumSize.height}" />
								</div><!-- .col-left -->
								<div class="col-right">
									<div class="inner">
